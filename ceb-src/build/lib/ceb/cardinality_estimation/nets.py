...
class SetConv(nn.Module):
    def __init__(self, sample_feats, predicate_feats, join_feats,
            ...
            dropouts=[0.0, 0.0, 0.0], use_sigmoid=True,return_rep=False):
    ...
    def forward(self, xbatch):
        ...
        try:
            ...
            # print(" ======= xbatch ======= ")
            # for k in xbatch.keys():
            #     print(xbatck[k].shape)
            # print(" ======= hid ======= ")
            # for e in tocat:
            #     print(e.shape)
            # pdb.set_trace()
