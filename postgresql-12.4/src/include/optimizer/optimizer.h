...
typedef Selectivity (*selectivity_hook_type) (PlannerInfo *root, List *clauses, int varRelid, JoinType jointype, SpecialJoinInfo *sjinfo);
extern PGDLLIMPORT selectivity_hook_type selectivity_hook;
...
extern Selectivity standard_clauselist_selectivity(PlannerInfo *root,
										  List *clauses,
										  int varRelid,
										  JoinType jointype,
										  SpecialJoinInfo *sjinfo);
