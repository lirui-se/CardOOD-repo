...
typedef void (*ExplainPrintPlan_CallBack_hook_type) (ExplainState *es, QueryDesc *queryDesc);
extern PGDLLIMPORT ExplainPrintPlan_CallBack_hook_type ExplainPrintPlan_CallBack_hook;
