...
selectivity_hook_type selectivity_hook = NULL;

Selectivity
standard_clauselist_selectivity(PlannerInfo *root,
					   List *clauses,
					   int varRelid,
					   JoinType jointype,
...
clauselist_selectivity(PlannerInfo *root,
					   ...
					   SpecialJoinInfo *sjinfo) {
    if(selectivity_hook) {
        return (*selectivity_hook)(root, clauses, varRelid, jointype, sjinfo);
    }
    else { 
        return standard_clauselist_selectivity(root, clauses, varRelid, jointype, sjinfo);
    }
}
...
/*
 * standard_clauselist_selectivity -
